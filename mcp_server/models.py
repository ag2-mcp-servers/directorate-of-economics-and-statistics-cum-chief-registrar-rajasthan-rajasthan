...
#   timestamp: 2025-06-28T15:23:45+00:00
...
class CertificateParameters(BaseModel):
    Cert_Type: str = Field(
        ...
        examples=['Birth_Certificate,Still_Birth_Certificate'],
    )
    DateofEvent: str = Field(..., description='Date of Birth', examples=['dd-mm-yyyy'])
    RegisNumber: str = Field(
        ..., description='Registration Number', examples=['081290010000006003XX']
    )
    Year: str = Field(
        ...,
...
class CertificateParameters1(BaseModel):
    DateofEvent: str = Field(..., description='Date of Death', examples=['dd-mm-yyyy'])
    RegisNumber: str = Field(
        ..., description='Registration Number', examples=['081290010000006003XX']
    )
    Year: str = Field(
...
class CertificateParameters2(BaseModel):
    DateofEvent: str = Field(
        ..., description='Date of Marriage', examples=['dd-mm-yyyy']
    )
    RegisNumber: str = Field(
        ..., description='Registration No.', examples=['081290010000006003XX']
    )
    Year: str = Field(
        ...,
        description='Year of Registration',
